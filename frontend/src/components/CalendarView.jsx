      ...
      {rows.map((row, rowIndex) => (
        <div key={`row-${rowIndex}`} className="calendar-grid">
          {row.map((date, dayIndex) => {
            ...
            const autoGeneratedCount = items.filter((item) => item.auto_generated).length;
                  ...
                  <>
                    ...
                    <div className="calendar-summary">
                      ...
                      {autoGeneratedCount > 0 && (
                        <span className="fixed-calendar-mark">
                          📌 {autoGeneratedCount}
                        </span>
                      )}
                    </div>
                    ...
                    {items.length > 0 && (
                      <div className="calendar-hover-preview">
                        {items.slice(0, 3).map((item) => (
                          <div key={item.id} className="calendar-hover-item">
                            <span>
                              {item.type === 'income'
                                ? '💰'
                                : item.type === 'transfer'
                        ...
                        {items.length > 3 && (
                          <div className="calendar-hover-more">
