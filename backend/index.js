...
const DEFAULT_LEDGER_USER_PINS = {
  '00000000-0000-0000-0000-000000000001': '0417',
  '00000000-0000-0000-0000-000000000002': '3531',
  '00000000-0000-0000-0000-000000000003': '0626',
};
...
async function ensureDefaultLedgerUserPins() {
  ...
  for (const user of rows) {
    if (user.pin_hash && await bcrypt.compare(plainPin, user.pin_hash)) continue;
